...
import { SuiSignAndExecuteTransactionBlockOutput, SuiSignMessageInput, SuiSignMessageOutput, SuiSignTransactionBlockOutput } from '@mysten/wallet-standard';
...
export interface IWallet {
    ...
    signAndExecuteTransactionBlock: (payload: SignAndExecutePayload) => Promise<SuiSignAndExecuteTransactionBlockOutput>;
    signTransactionBlock: (payload: SignTransactionBlockInput) => Promise<SuiSignTransactionBlockOutput>;
}
